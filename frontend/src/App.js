              ...
              <div className="card">
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  {result.chunks.map((chunk, i) => (
                    <div className="source-location-item" key={i}>
                      <span className="source-location-icon">📄</span>
                      <div style={{ flex: 1 }}>
                        <div className="source-location-file">{chunk.source}</div>
                        <div className="source-location-meta">
                          <span className="source-pill source-pill-rank">#{i + 1} match</span>
                          <span className="source-pill source-pill-page">Page {chunk.page ?? "—"}</span>
                          <span className="source-pill source-pill-score">score: {chunk.score.toFixed(4)}</span>
                        </div>
                      </div>
                    </div>
                  ))}
